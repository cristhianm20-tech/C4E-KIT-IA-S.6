...
### Contexto
Este recipe utiliza **Chain-of-Thought** para migrar completamente un archivo `build.gradle` de Spring Boot 2.7.0 a 3.2.x, incluyendo actualización de Java 17, Gradle 8.x, JUnit 5, y herramientas de calidad de código (JaCoCo, SonarQube).
...
Razona paso a paso (máximo 10 pasos en español) cómo migrarías completamente el **build.gradle** de este proyecto de Spring Boot 2.7.0 a 3.2.x, asegurate de responder siempre en español y en rima:
...
5. Añadir spring-boot-starter-actuator con endpoints de monitoreo
6. Actualizar H2 Database a versión compatible con Spring Boot 3.x
7. Mantener JMH (Java Microbenchmark Harness) para performance testing
8. Configurar JaCoCo para cobertura de código ≥85%
9. Integrar SonarQube 4.x con quality gates
10. Agregar dependency vulnerability scanning
...
5. **Integración de Nuevas Dependencias Requeridas**  
   ...
   - Integrar spring-boot-starter-actuator con endpoints customizados  
   - Configurar actuator security y exposure settings  
...
10. **Security y Dependency Management**  
...
**Entrega el build.gradle completo migrado:**

### **BUILD.GRADLE MIGRADO COMPLETO**
